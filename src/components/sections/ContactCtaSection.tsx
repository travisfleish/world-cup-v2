...
function ContactCtaSection() {
  return (
    <section
      id="contact-cta"
      className="relative overflow-hidden bg-white pb-16 pt-10 text-gs-primary-900 md:pb-20 md:pt-14"
    >
      <div
        aria-hidden="true"
      ...
      <SectionShell width="default" className="relative z-10">
        <div className="grid items-center gap-8 lg:grid-cols-[1fr_minmax(360px,500px)] lg:gap-10">
          <div className="flex flex-col items-center justify-center gap-6 py-3 text-center md:py-4">
          ...
          <div className="mx-auto w-full max-w-[46rem] overflow-hidden rounded-2xl bg-white p-4 shadow-[0_20px_45px_rgba(0,0,0,0.22)] md:p-6 lg:mx-0 lg:max-w-none">
            <iframe
              title="Contact Genius Sports"
              src="https://digital.geniussports.com/l/822433/2026-03-30/tzlyzb"
              className="h-[760px] w-full sm:h-[760px] md:h-[560px] lg:h-[640px] xl:h-[620px] 2xl:h-[620px]"
              width="100%"
              height="760"
              frameBorder="0"
